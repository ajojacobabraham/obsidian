...
### 6.4 Framework of Internal Control as per SA

SA 315 defines the system of internal control as "the process designed implemented adn maintained by those charged with governance, management and other personnel to provide reasonable assurance about the achievement of an entity's objectives regarding the reliability of financial reporting etc."

An internal control system :
(Benefits of IC system)
...
3. assists compliance wtih applicable laws and regulations 
4. helps in safegaurding the assets of the entity

Five Components of internal control system :
1. Control Environment 
	Set of standards, processes and structures that provide basis for carrying out IC across the org.
	The control env. comprises the integrity and and ethical vaules of the org.
2. Risk assessment
	involves a dynamic and iterative process for identifying and assessing risks to the achievement of objectives.
3. Control Activities 
	The control activities include the elements that operate te ensure transactions are authorised, duties are segregated, adequate documents and records are maintained etc.
	Developed to manage, mitigate and reduce the risks associated with each business process.
4. Information and communication
	Info is necessary for the entity to carry out internal control responsibilities in support of the achievement of its objectives.
	Comm. is the continual, iterative process of providing, sharing and obtaining necessary information.
5. Monitoring of controls 
	Is an ongoing cyclical process. 
	Ongoing evaluations seperate evaluations or some combination of the two are used to ascertain whether each of the five components including the controls to affect the principles within each componet is present and functioning.

### 6.5 Limitations of IC system
- Mgmt. consideration that the cost of IC does not exceed the expected benefits to be derived 
- Most IC do not tend to be directed at transactions of unusual nature. The potential for human error, such as due to carelessness, distraction,mistakes of judgement and misunderstanding of instructions 
- the possibility of circumvention of IC through collusion with employees or with parties outside the entity
- the possibility that a person responsible for exercising an internal control could abuse the responsibility.
- Manipulations by mgmt. with respect to transactions or estimates and judgements required in preparation of financial statements.

![[Diagrammatic Representation of Business Processes.png]]

**Controls to be checked at three levels**

![[Controls to be checked at three levels 1.png]]

![[Controls to be checked at three levels 2.png]]

![[Controls to be checked at three levels 3.png]]


![[Regulatory and compliance requirements.png]]
