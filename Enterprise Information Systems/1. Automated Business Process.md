...
2. Objective setting : ERM ensures that mgmt. has a process to set objectives and the chosen objectives support and align with the entitys mission/vision and are consistant 