...
<thead>
  <tr>
    <th class="tg-0lax">Particulars </th>
    <th class="tg-0lax">Installed</th>
    <th class="tg-0lax">Cloud </th>
  </tr>
</thead>
<tbody>
  <tr>
    <td class="tg-0lax">Installation and Maintenance</td>
    <td class="tg-0lax">Installed on Hard Disk, one by one on each computer</td>
    <td class="tg-0lax">Installation on user computer not required. Update and maintenance responsibility of service provider </td>
  </tr>
  <tr>
    <td class="tg-0lax">Accessibility</td>
    <td class="tg-0lax">User needs to go to the computer on which it is installed.<br>Cannot be user from any other computer.</td>
    <td class="tg-0lax">Available through online access. <br>Only a browser and internet connection required </td>
  </tr>
  <tr>
    <td class="tg-0lax">Mobile application</td>
    <td class="tg-0lax">Using through mobile app may be difficult </td>
    <td class="tg-0lax">Easy access as data is available 24 x 7 </td>
  </tr>
  <tr>
    <td class="tg-0lax"></td>
    <td class="tg-0lax"></td>
