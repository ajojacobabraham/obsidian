...
Application software performs many funcitons such as receiving the inputs fromthe user, interprets the instructions and performs logical functions so a desired output is achieved. e.g. SAP, Oracle Financials, MFG P